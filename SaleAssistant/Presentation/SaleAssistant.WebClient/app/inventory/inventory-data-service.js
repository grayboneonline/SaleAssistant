(function () {
    ...
    angular.module('saleAssistant').factory('inventoryDataService', inventoryDataService);

    inventoryDataService.$inject = ['$q', 'saHttpService'];

    function inventoryDataService($q, saHttpService) {
