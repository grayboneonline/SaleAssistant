(function () {
    ...
    angular.module('saleAssistant').factory('customerDataService', customerDataService);

    customerDataService.$inject = ['$q', 'saHttpService'];

    function customerDataService($q, saHttpService) {
